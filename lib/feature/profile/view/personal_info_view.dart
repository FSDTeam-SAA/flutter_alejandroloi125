...
final TextStyle typeStyle = TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w400,);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.black,
     ...
     Text(languageController.t('personal_info'),style: TextStyle(color: Colors.white,fontSize: 24,fontWeight: FontWeight.w700),),
    ...
    body: Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
        ...
        Padding(
          padding:  EdgeInsets.symmetric(vertical: 8),
          child: Text(languageController.t('nationality'),style: typeStyle,),
        ),
