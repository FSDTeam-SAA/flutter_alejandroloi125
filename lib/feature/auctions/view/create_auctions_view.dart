...
class _CreateAuctionsViewState extends State<CreateAuctionsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                 ...
                 Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                   Expanded(
                     child: CustomTextField(hintText: "10 Minutes",prefixIcon: Icons.watch_later_outlined,
                     showBorder: true,),
                   ),
                   SizedBox(width: 8,),
                   Expanded(
                     child: CustomTextField(hintText: "20 Minutes",prefixIcon: Icons.watch_later_outlined,
                     showBorder: true,),
                   ),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                   Expanded(
                     child: CustomTextField(hintText: "30 Minutes",prefixIcon: Icons.watch_later_outlined,
                     showBorder: true,),
                   ),    SizedBox(width: 8,),
                   Expanded(
                     child: CustomTextField(hintText: "1 hour",prefixIcon: Icons.watch_later_outlined,
                     showBorder: true,),
                   ),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                    Expanded(
                      child: CustomTextField(hintText: "Date",prefixIcon: Icons.calendar_today_outlined,
                        showBorder: true,),
                    ),    SizedBox(width: 8,),
                    Expanded(
                      child: CustomTextField(hintText: "Time",prefixIcon: Icons.watch_later_outlined,
                        showBorder: true,),
                    ),
      ...
      const Text("Option 1", style: bodyText1),
      ],
    ),
    Row(
    children: [
    ...
    const Text("Option 2", style: bodyText1),
    ],
    ),
    ],
    ),
